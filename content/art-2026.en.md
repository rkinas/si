---
title: "AI at the Threshold of 2026 – From Fascination to Maturity?"
...
ai_note: >
  AI assisted in the creation of this article in the following ways: translation of complex texts and concepts into Polish (DeepL). The original was written in Polish, and the Google Gemini-3-Pro model translated it into English (with manual corrections). AI was also used for spell-checking and proofreading. Gemini-3-Pro-Flash for editing some sentences for style. Overleaf with an LLM plugin as the LaTeX editor – style improvement suggestions. Research using AI-powered search engines. For understanding source publications throughout the year, OpenAI ChatGPT from 4 to 5.2 and the Gemini 3 family of models were used. All ideas for categorization, reflections, and topic development were conceived by a human and written by human hand.
bibliography:
